...
function ChatFunction({
  ...
  return (
    <div className="relative flex flex-col justify-between w-auto lg:w-1/2 h-full lg:h-auto lg:min-h-[calc(100vh_-_var(--vh-offset)_-_100px)] max-w-full bg-transparent">
      <>
        <div>
          <div
            className="overflow-y-auto overflow-x-hidden max-h-[calc(100vh_-_var(--vh-offset)_-_8rem)] lg:max-h-[calc(100vh_-_var(--vh-offset)_-_12rem)] p-4 lg:py-0 lg:px-4"
