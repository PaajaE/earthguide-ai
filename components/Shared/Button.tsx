...
export const Button: FC<Props> = ({
  ...
  return (
    <div
      className={`flex flex-row justify-start first-of-type:mr-2 cursor-pointer items-start gap-2.5 h-[55px] px-[13px] py-3.5 rounded-t-[15px] rounded-bl-[15px] box-border bg-[${bgColor}]`}
